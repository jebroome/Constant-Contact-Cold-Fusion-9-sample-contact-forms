<cfcomponent displayname="Contacts" output="false" extends="Application">
...
<cffunction 
	...
	<cfset LOCAL.contactXml = xmlParse(doServerCall("get", "#APPLICATION.apiPath#/contacts?email=#ARGUMENTS.emailAddress#"))>
...
<cffunction 
	...
	<cfset LOCAL.postResponse = doServerCall("post", "#APPLICATION.apiPath#/contacts", ARGUMENTS.addXml)>
...
<entry xmlns="http://www.w3.org/2005/Atom">
	...
	<content type="application/vnd.ctct+xml">
		<Contact xmlns="http://ws.constantcontact.com/ns/1.0/">
			...
			<Note></Note>
			<OptInSource>#APPLICATION.optInSource#</OptInSource>
